...
public final class ConfigLoader {
  ...
  private static final Map<String, String> ENV_MAPPING =
      Map.ofEntries(
          ...
          Map.entry("cluster.max.concurrent.requests", "AH_CLUSTER_MAX_CONCURRENT_REQUESTS"),
          Map.entry("cluster.sharding.enabled", "AH_CLUSTER_SHARDING_ENABLED"),
          Map.entry("cluster.shard.count", "AH_CLUSTER_SHARD_COUNT"),
          Map.entry("cluster.shard.algorithm", "AH_CLUSTER_SHARD_ALGORITHM"),
          Map.entry("cluster.shard.key-fields", "AH_CLUSTER_SHARD_KEY_FIELDS"),
          Map.entry("cluster.shard.override-label", "AH_CLUSTER_SHARD_OVERRIDE_LABEL"),
          Map.entry("cluster.shard.missing-key-policy", "AH_CLUSTER_SHARD_MISSING_KEY_POLICY"),
